...
export const ICON_PATHS: Record<string, string> = {
  ...
  // Reporting / data nouns a dashboard needs. Without these a prompt about
  // usage, billing or support resolved to nothing and drew an empty path.
  activity: 'M3 12h4l3 8 4-16 3 8h4',
  'trending-up': 'M3 17l6-6 4 4 8-8M15 7h6v6',
  'trending-down': 'M3 7l6 6 4-4 8 8M15 17h6v-6',
  gauge: 'M3.5 18a8.5 8.5 0 1 1 17 0M12 18l4.5-5.5M12 18h.01',
  ...
  percent: 'M19 5L5 19M7.5 9a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zM16.5 20a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z',
  wallet: 'M3 7a2 2 0 0 1 2-2h13v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7zM18 10h3v4h-3a2 2 0 0 1 0-4z',
  help: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18zM9.5 9.5A2.5 2.5 0 0 1 14 11c0 1.7-2 2-2 3.5M12 18h.01',
  shield: 'M12 3l8 3v6c0 5-3.5 8-8 9-4.5-1-8-4-8-9V6z',
  plug: 'M9 3v5M15 3v5M6 8h12v3a6 6 0 0 1-12 0V8zM12 17v4',
  leaf: 'M4 20C4 10 12 4 20 4c0 9-6 16-16 16zM4 20c4-5 8-7 12-8',
  thermometer: 'M14 14.8V5a2 2 0 1 0-4 0v9.8a4 4 0 1 0 4 0z',
  briefcase: 'M3 8h18v12H3zM8 8V5h8v3M3 13h18',
  building: 'M4 21V4h10v17M14 10h6v11M7 8h1M11 8h1M7 12h1M11 12h1M7 16h1M11 16h1M17 14h1M17 18h1',
  truck: 'M3 6h11v10H3zM14 10h4l3 3v3h-7zM7.5 19a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM17.5 19a2 2 0 1 0 0-4 2 2 0 0 0 0 4z',
  flag: 'M5 21V4h14l-3 5 3 5H5',
  bookmark: 'M6 3h12v18l-6-4-6 4V3',
  clipboard: 'M9 4h6v3H9zM9 5H5v16h14V5h-4M9 12h6M9 16h6',
  award: 'M12 15a6 6 0 1 0 0-12 6 6 0 0 0 0 12zM8.5 14L7 22l5-3 5 3-1.5-8'
}
...
const ICON_ALIASES: Record<string, string> = {
  ...
  money: 'dollar', price: 'dollar', cost: 'dollar', payment: 'dollar', currency: 'dollar', usd: 'dollar', cash: 'dollar',
  ...
  bullet: 'list', items: 'list', lines: 'list', feed: 'list',
  reload: 'refresh', sync: 'refresh', retry: 'refresh', repeat: 'refresh', loading: 'refresh',
  start: 'play', video: 'play', media2: 'play',
  graph: 'chart', stats: 'chart', analytics: 'chart', report2: 'chart', bars: 'chart', 'bar-chart': 'chart', trending: 'trending-up', insights: 'chart',
  ...
  fire: 'flame', streak: 'flame', hot: 'flame', gas: 'flame', heating: 'flame',
  reading: 'book', library: 'book', guide: 'book', docs: 'book', manual: 'book',
  droplet: 'drop', water: 'drop', humidity: 'drop', liquid: 'drop', rain: 'drop',
  // Domain nouns. A utility dashboard asks for these by name and used to get
  // nothing back, which drew an empty path where an icon should have been.
  usage: 'activity', consumption: 'activity', pulse: 'activity', live: 'activity', monitor: 'activity', realtime: 'activity',
  billing: 'card', invoices: 'receipt', bill: 'receipt', statement: 'receipt', charges: 'receipt',
  overview: 'grid', summary: 'grid', panels: 'grid',
  support: 'help', helpcenter: 'help', faq: 'help', contactus: 'help', 'question-circle': 'help', assistance: 'help',
  meter: 'gauge', speed: 'gauge', performance: 'gauge', demand: 'gauge', capacity: 'gauge',
  electricity: 'bolt', electric: 'bolt', kwh: 'bolt', kw: 'bolt', grid2: 'bolt',
  utility: 'plug', outlet: 'plug', socket: 'plug', appliance: 'plug',
  emissions: 'leaf', carbon: 'leaf', sustainability: 'leaf', renewable: 'leaf', eco: 'leaf', green: 'leaf',
  solar: 'sun', daylight: 'sun',
  temperature: 'thermometer', climate: 'thermometer', heat: 'thermometer',
  growth: 'trending-up', increase: 'trending-up', rising: 'trending-up', up2: 'trending-up',
  decline: 'trending-down', decrease: 'trending-down', falling: 'trending-down', down2: 'trending-down',
  data: 'table', rows: 'table', spreadsheet: 'table', dataset: 'table', records: 'table', ledger: 'table',
  storage: 'database', server: 'database', backup: 'database',
  'pie-chart': 'pie', breakdown: 'pie', distribution: 'pie', share3: 'pie',
  discount: 'percent', rate2: 'percent', tariff: 'percent',
  balance: 'wallet', funds: 'wallet', credit: 'wallet',
  protection: 'shield', privacy: 'shield', shielded: 'shield', trust: 'shield',
  company: 'building', office: 'building', property: 'building', site2: 'building', premises: 'building',
  work: 'briefcase', business: 'briefcase', portfolio: 'briefcase', job: 'briefcase',
  delivery: 'truck', shipping: 'truck', logistics: 'truck', fleet: 'truck',
  goal: 'flag', milestone: 'flag', target: 'flag', priority: 'flag',
  saved: 'bookmark', bookmarks: 'bookmark', watchlist: 'bookmark',
  tasks: 'clipboard', checklist: 'clipboard', form: 'clipboard', survey: 'clipboard', audit: 'clipboard',
  achievement: 'award', badge2: 'award', reward: 'award', certified: 'award',
}
